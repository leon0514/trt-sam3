...
PYBIND11_MODULE(trtsam3, m)
{
    ...
    py::class_<Sam3Input>(m, "Sam3Input")
        ...
        .def_readwrite("confidence_threshold", &Sam3Input::confidence_threshold)
        .def_readwrite("merge_results", &Sam3Input::merge_results)
        .def_readwrite("pre_detect_labels", &Sam3Input::pre_detect_labels)
        .def_readwrite("prompts", &Sam3Input::prompts)
        // ominicrop 配置参数
        .def_readwrite("pre_crop_max_size", &Sam3Input::pre_crop_max_size)
        .def_readwrite("pre_crop_padding", &Sam3Input::pre_crop_padding)
        .def_readwrite("pre_crop_w_diou", &Sam3Input::pre_crop_w_diou)
        .def_readwrite("pre_crop_w_expansion", &Sam3Input::pre_crop_w_expansion)
        .def_readwrite("pre_crop_count_penalty", &Sam3Input::pre_crop_count_penalty)
        .def_readwrite("pre_crop_nms_threshold", &Sam3Input::pre_crop_nms_threshold)
        .def_readwrite("pre_crop_enable_ar_fix", &Sam3Input::pre_crop_enable_ar_fix)
        .def_readwrite("pre_crop_target_ar", &Sam3Input::pre_crop_target_ar)
